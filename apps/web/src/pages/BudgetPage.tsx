...
import { Button, Card, Col, Empty, Form, Input, InputNumber, Progress, Row, Skeleton, Statistic, Typography, message } from 'antd';
import { SaveOutlined } from '@ant-design/icons';
import type { Budget, BudgetInput, Category, FinanceStats } from '@lifeos/shared';
...
export function BudgetPage() {
  ...
  const load = useCallback(async () => {
    setLoading(true);
    try {
      const [nextBudget, nextCategories, nextStats] = await Promise.all([
